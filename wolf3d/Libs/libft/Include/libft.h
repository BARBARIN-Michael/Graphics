...
/*   Updated: 2015/05/01 11:50:44 by mbarbari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				*ft_itoa(intmax_t a);
char				*ft_utoa(uintmax_t a);
char				*ft_wtoa(wint_t a);
char				*ft_ntoa(uintmax_t a, char *b);
...
void				ft_lstadd_back(t_list **alst, t_list *newi);
void				ft_lstiter(t_list *lst, void (*f)(t_list *elem));
t_list				*ft_lstmap(t_list *lst, t_list *(*f)(t_list *elem));
char				*ft_replace(char *a, char *b, char *c);
char				*ft_nreplace(char *a, char *b, char *c, size_t d);
char				*ft_n1replace(char *s1, char *mod, char *s2, size_t n);
char				*ft_replace_free(char *a, char *b, char *c, int d);
